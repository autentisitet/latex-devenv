...
\newcommand{\myinstitute}{xxxxxxxxxxxx \\ ############}
...
\begin{frame}{Performance Assessment Metrics}
  ...
  \vspace{0.5em}
  \small \textbf{Note:} The correction factor is auto-scaled using \texttt{adjustbox} to maintain legibility regardless of term length.
\end{frame}
